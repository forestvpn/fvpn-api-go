...
// checks if the PaginatedPaymentMethodList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PaginatedPaymentMethodList{}
...
type _PaginatedPaymentMethodList PaginatedPaymentMethodList
...
func NewPaginatedPaymentMethodList(results []PaymentMethod) *PaginatedPaymentMethodList {
	this := PaginatedPaymentMethodList{}
...
func (o *PaginatedPaymentMethodList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedPaymentMethodList := _PaginatedPaymentMethodList{}

	err = json.Unmarshal(data, &varPaginatedPaymentMethodList)

	if err != nil {
		return err
	}

	*o = PaginatedPaymentMethodList(varPaginatedPaymentMethodList)
...
type NullablePaginatedPaymentMethodList struct {
	value *PaginatedPaymentMethodList
	isSet bool
}
...
func NewNullablePaginatedPaymentMethodList(val *PaginatedPaymentMethodList) *NullablePaginatedPaymentMethodList {
	return &NullablePaginatedPaymentMethodList{value: val, isSet: true}
}
