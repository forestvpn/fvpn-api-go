...
// checks if the DeviceAnalyticsDevice type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeviceAnalyticsDevice{}
...
func NewNullableDeviceAnalyticsDevice(val *DeviceAnalyticsDevice) *NullableDeviceAnalyticsDevice {
	return &NullableDeviceAnalyticsDevice{value: val, isSet: true}
}
