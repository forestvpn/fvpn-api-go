...
type _PaginatedAccountList PaginatedAccountList
...
func (o *PaginatedAccountList) UnmarshalJSON(data []byte) (err error) {
	...
	varPaginatedAccountList := _PaginatedAccountList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPaginatedAccountList)

	if err != nil {
		return err
	}

	*o = PaginatedAccountList(varPaginatedAccountList)
