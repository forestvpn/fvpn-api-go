...
// checks if the SetDefaultPaymentMethodRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SetDefaultPaymentMethodRequest{}
...
func NewSetDefaultPaymentMethodRequest(paymentMethod string) *SetDefaultPaymentMethodRequest {
	this := SetDefaultPaymentMethodRequest{}
...
type NullableSetDefaultPaymentMethodRequest struct {
	value *SetDefaultPaymentMethodRequest
	isSet bool
}
...
func NewNullableSetDefaultPaymentMethodRequest(val *SetDefaultPaymentMethodRequest) *NullableSetDefaultPaymentMethodRequest {
	return &NullableSetDefaultPaymentMethodRequest{value: val, isSet: true}
}
