...
func (r ApiSearchNodesRequest) Countries(countries string) ApiSearchNodesRequest {
	r.countries = &countries
	return r
}

// The pagination cursor value.
func (r ApiSearchNodesRequest) Cursor(cursor string) ApiSearchNodesRequest {
	r.cursor = &cursor
	return r
}

// Maximum distance (format: 10km, 5mi)
func (r ApiSearchNodesRequest) Distance(distance string) ApiSearchNodesRequest {
	r.distance = &distance
	return r
}

// Filter by exit node status
func (r ApiSearchNodesRequest) IsExitNode(isExitNode bool) ApiSearchNodesRequest {
	r.isExitNode = &isExitNode
	return r
}

// Latitude for location search
func (r ApiSearchNodesRequest) Lat(lat float64) ApiSearchNodesRequest {
	r.lat = &lat
	return r
}
...
func (r ApiSearchNodesRequest) Lon(lon float64) ApiSearchNodesRequest {
	r.lon = &lon
	return r
}

// Order by distance
func (r ApiSearchNodesRequest) OrderByDistance(orderByDistance bool) ApiSearchNodesRequest {
	r.orderByDistance = &orderByDistance
	return r
}

// Search nodes by hostname, tags, OS, OS arch, distro, distro codename, or public key
func (r ApiSearchNodesRequest) Q(q string) ApiSearchNodesRequest {
	r.q = &q
	return r
}

// Filter by tags
func (r ApiSearchNodesRequest) Tags(tags string) ApiSearchNodesRequest {
	r.tags = &tags
	return r
}

func (r ApiSearchNodesRequest) Execute() (*PaginatedNodeList, *http.Response, error) {
...
func (a *NodeAPIService) SearchNodesExecute(r ApiSearchNodesRequest) (*PaginatedNodeList, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NodeAPIService.SearchNodes")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/nodes/search/"
